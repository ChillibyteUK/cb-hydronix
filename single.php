    ...
    <div class="row">
        <div class="col-lg-6">
            <div class="share-icons">Share: 
                ...
                <a target="_blank" href="https://twitter.com/share?url=<?=$url?>"><i class="fa-brands fa-x-twitter"></i></a>
                <a target="_blank" href="http://www.facebook.com/sharer.php?u=<?=$url?>"><i class="fa-brands fa-facebook-f"></i></a>
                <a target="_blank" href="http://www.linkedin.com/shareArticle?url=<?=$url?>"><i class="fa-brands fa-linkedin"></i></a>
            </div>
        </div>
        <div class="col-lg-6">
            <?php
