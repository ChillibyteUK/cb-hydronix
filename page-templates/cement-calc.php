    ...
    <div class="tab-content" id="myTabContent">
        <div class="tab-pane fade show active" id="recipe" role="tabpanel" aria-labelledby="recipe-tab">
            <div class="mt-3">
                ...
                <div class="row g-5">
                    <div class="col-lg-6">
                        ...
                        <div class="mb-3 row border-bottom">
                            ...
                            <div class="col-sm-6 col-xl-4">
                                <div class="input-group mb-2">
                                    <input type="number" class="form-control highlight-green" id="sand1" value="1000" oninput="updateSlider(this); calculateAggregateTotal(); calculateBinderTotal(); calculateTotalDryWeight(); calculateRatios();">
                        ...
                        <div class="mb-3 row border-bottom">
                            ...
                            <div class="col-sm-6 col-xl-4">
                                <div class="input-group mb-2">
                                    <input type="number" class="form-control highlight-green" id="sand2" value="1000" oninput="updateSlider(this); calculateAggregateTotal(); calculateBinderTotal(); calculateTotalDryWeight(); calculateRatios();">
                                    <span class="input-group-text">kg/m<sup>3</sup></span>
                                </div>
                        ...
                        <div class="mb-3 row border-bottom">
                            ...
                            <div class="col-sm-6 col-xl-4">
                                <div class="input-group mb-2">
                                    <input type="number" class="form-control highlight-green" id="aggregate" value="650" oninput="updateSlider(this); calculateAggregateTotal(); calculateBinderTotal(); calculateTotalDryWeight(); calculateRatios();">
                                    <span class="input-group-text">kg/m<sup>3</sup></span>
                                </div>
                        ...
                        <div class="mb-3 row border-bottom">
                            ...
                            <div class="col-sm-6 col-xl-4">
                                <div class="input-group">
                                    <input type="number" class="form-control highlight-green" id="otherAggregates" value="0" oninput="calculateAggregateTotal(); calculateBinderTotal(); calculateTotalDryWeight(); calculateRatios();">
                                    <span class="input-group-text">kg/m<sup>3</sup></span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-3 row">
                            <label class="col-sm-6 col-xl-8 col-form-label fw-bold">Total Dry Weight of Aggregates</label>
                            <div class="col-sm-6 col-xl-4">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-6 col-xl-4">
                                <div class="input-group">
                                    <input type="number" class="form-control highlight-green" id="opc" value="300" oninput="calculateAggregateTotal(); calculateBinderTotal(); calculateTotalDryWeight(); calculateRatios();">
                                    <span class="input-group-text">kg/m<sup>3</sup></span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-6 col-xl-4">
                                <div class="input-group">
                                    <input type="number" class="form-control highlight-green" id="pfa" value="0" oninput="calculateAggregateTotal(); calculateBinderTotal(); calculateTotalDryWeight(); calculateRatios();">
                                    <span class="input-group-text">kg/m<sup>3</sup></span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-6 col-xl-4">
                                <div class="input-group">
                                    <input type="number" class="form-control highlight-green" id="ggbs" value="50" oninput="calculateAggregateTotal(); calculateBinderTotal(); calculateTotalDryWeight(); calculateRatios();">
                                    <span class="input-group-text">kg/m<sup>3</sup></span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-6 col-xl-4">
                                <div class="input-group">
                                    <input type="number" class="form-control highlight-green" id="otherCement" value="0" oninput="calculateAggregateTotal(); calculateBinderTotal(); calculateTotalDryWeight(); calculateRatios();">
                                    <span class="input-group-text">kg/m<sup>3</sup></span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-3 row">
                            <label class="col-sm-6 col-xl-8 col-form-label fw-bold">Total Cementitious Materials (Binder)</label>
                            <div class="col-sm-6 col-xl-4">
                ...
                <div class="mb-3 row">
                    <label class="col-sm-8 col-form-label fw-bold">Total Dry Weight for Recipe</label>
                    <div class="col-sm-4">
                ...
                <div class="mb-3 row">
                    <label for="water" class="col-sm-8 col-form-label">Water (litres)</label>
                    <div class="col-sm-4">
                        <input type="number" class="form-control highlight-green" id="water" value="150" oninput="calculateAggregateTotal(); calculateBinderTotal(); calculateTotalDryWeight(); calculateRatios();">
                    </div>
                </div>

                <div class="mb-3 row">
                    <label class="col-sm-8 col-form-label fw-bold">Water / Binder Ratio</label>
                    <div class="col-sm-4">
                ...
                <div class="mb-3 row">
                    <label class="col-sm-8 col-form-label fw-bold">Aggregate / Binder Ratio</label>
                    <div class="col-sm-4">
        ...
        <div class="tab-pane fade" id="production-data" role="tabpanel" aria-labelledby="production-data-tab">
            <div class="mt-3">
                ...
                <div class="mb-3 row">
                    <label for="volumePerDay" class="col-sm-8 col-form-label">Volume of concrete per day</label>
                    <div class="col-sm-4">
                        <div class="input-group">
                            <input type="number" class="form-control highlight-green" id="volumePerDay" value="100">
                            <span class="input-group-text"> m<sup>3</sup></span>
                        </div>
                    </div>
                </div>
                <div class="mb-3 row">
                    <label for="daysPerYear" class="col-sm-8 col-form-label">Days worked per year</label>
                    <div class="col-sm-4">
                        <div class="input-group">
                            <input type="number" class="form-control highlight-green" id="daysPerYear" value="250">
                            <span class="input-group-text">Days</span>
                        </div>
                    </div>
                </div>
                <div class="mb-3 row">
                    <label for="cementCost" class="col-sm-8 col-form-label">Cement cost/tonne</label>
                    <div class="col-sm-4">
                        <div class="input-group">
                            <span class="input-group-text">£/$/€</span>
                            <input type="number" class="form-control highlight-green" id="cementCost" value="80">
                        </div>
                    </div>
                </div>
                <div class="mb-3 row">
                    <label for="cementCO2" class="col-sm-8 col-form-label">Cement CO2 Equivalent</label>
                    <div class="col-sm-4">
                        <div class="input-group">
                            <input type="number" class="form-control highlight-green" id="cementCO2" value="928">
                            <span class="input-group-text">kgCO<sub>2</sub>e/t</span>
                        </div>
                    </div>
                </div>
                <div class="mb-3 row">
                    <label for="productionCost" class="col-sm-8 col-form-label">Production Cost</label>
                    <div class="col-sm-4">
                        <div class="input-group">
                            <input type="number" class="form-control highlight-green" id="productionCost" value="100">
                            <span class="input-group-text">£/m<sup>3</sup></span>
                        </div>
                    </div>
                </div>
                <div class="mb-3 row">
                    <label for="salePrice" class="col-sm-8 col-form-label">Sale price</label>
                    <div class="col-sm-4">
                        <div class="input-group">
                            <input type="number" class="form-control highlight-green" id="salePrice" value="150">
                            <span class="input-group-text">£/m<sup>3</sup></span>
                        </div>
                    </div>
                </div>
        ...
        <div class="tab-pane fade" id="material-moisture" role="tabpanel" aria-labelledby="material-moisture-tab">
            <div class="mt-3">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-4">
                        <select class="form-select highlight-green" id="moistureMethod" onchange="toggleMoistureFields();">
                ...
                <div id="moistureFields">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-8">
                            <div class="input-group mb-2">
                                ...
                                <input type="number" class="form-control highlight-green" id="sand1Nominal" value="6.5" oninput="calculatePotentialManual(); calculatePotentialAutomatic();">
                                <span class="input-group-text">%</span>
                            </div>
                            <div class="input-group mb-2 manual-field">
                                <span class="input-group-text">Min</span>
                                <input type="number" class="form-control highlight-green" id="sand1Min" value="2.5" oninput="calculatePotentialManual();">
                                <span class="input-group-text">%</span>
                                <span class="input-group-text">Max</span>
                                <input type="number" class="form-control highlight-green" id="sand1Max" value="10.0" oninput="calculatePotentialManual();">
                                <span class="input-group-text">%</span>
                            </div>
                            <div class="input-group mb-2 automatic-field" style="display: none;">
                                <span class="input-group-text">Accuracy</span>
                                <input type="number" class="form-control highlight-green" id="sand1Accuracy" value="0.5" oninput="calculatePotentialAutomatic();">
                                <span class="input-group-text">+/- %</span>
                            </div>
                            <div class="input-group">
                                <span class="input-group-text">Potential Maximum Unknown Moisture</span>
                                <input type="text" class="form-control" id="sand1Potential" readonly>
                                <span class="input-group-text">%</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-8">
                            <div class="input-group mb-2">
                                <span class="input-group-text">Nominal Moisture</span>
                                <input type="number" class="form-control highlight-green" id="sand2Nominal" value="5.5" oninput="calculatePotentialManual(); calculatePotentialAutomatic();">
                                <span class="input-group-text">%</span>
                            </div>
                            <div class="input-group mb-2 manual-field">
                                <span class="input-group-text">Min</span>
                                <input type="number" class="form-control highlight-green" id="sand2Min" value="4.0" oninput="calculatePotentialManual();">
                                <span class="input-group-text">%</span>
                                <span class="input-group-text">Max</span>
                                <input type="number" class="form-control highlight-green" id="sand2Max" value="7.0" oninput="calculatePotentialManual();">
                                <span class="input-group-text">%</span>
                            </div>
                            <div class="input-group mb-2 automatic-field" style="display: none;">
                                <span class="input-group-text">Accuracy</span>
                                <input type="number" class="form-control highlight-green" id="sand2Accuracy" value="0.5" oninput="calculatePotentialAutomatic();">
                                <span class="input-group-text">+/- %</span>
                            </div>
                            <div class="input-group">
                                <span class="input-group-text">Potential Maximum Unknown Moisture</span>
                                <input type="text" class="form-control" id="sand2Potential" readonly>
                                <span class="input-group-text">%</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-8">
                            <div class="input-group mb-2">
                                <span class="input-group-text">Nominal Moisture</span>
                                <input type="number" class="form-control highlight-green" id="aggregateNominal" value="2.5" oninput="calculatePotentialManual(); calculatePotentialAutomatic();">
                                <span class="input-group-text">%</span>
                            </div>
                            <div class="input-group mb-2 manual-field">
                                <span class="input-group-text">Min</span>
                                <input type="number" class="form-control highlight-green" id="aggregateMin" value="2.0" oninput="calculatePotentialManual();">
                                <span class="input-group-text">%</span>
                                <span class="input-group-text">Max</span>
                                <input type="number" class="form-control highlight-green" id="aggregateMax" value="4.0" oninput="calculatePotentialManual();">
                                <span class="input-group-text">%</span>
                            </div>
                            <div class="input-group mb-2 automatic-field" style="display: none;">
                                <span class="input-group-text">Accuracy</span>
                                <input type="number" class="form-control highlight-green" id="aggregateAccuracy" value="0.5" oninput="calculatePotentialAutomatic();">
                                <span class="input-group-text">+/- %</span>
                            </div>
                            <div class="input-group">
                                <span class="input-group-text">Potential Maximum Unknown Moisture</span>
                                <input type="text" class="form-control" id="aggregatePotential" readonly>
                                <span class="input-group-text">%</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-8">
                            <div class="input-group mb-2">
                                <span class="input-group-text">Nominal Moisture</span>
                                <input type="number" class="form-control highlight-green" id="otherAggregatesNominal" value="0.0" oninput="calculatePotentialManual(); calculatePotentialAutomatic();">
                                <span class="input-group-text">%</span>
                            </div>
                            <div class="input-group mb-2 manual-field">
                                <span class="input-group-text">Min</span>
                                <input type="number" class="form-control highlight-green" id="otherAggregatesMin" value="0.0" oninput="calculatePotentialManual();">
                                <span class="input-group-text">%</span>
                                <span class="input-group-text">Max</span>
                                <input type="number" class="form-control highlight-green" id="otherAggregatesMax" value="0.0" oninput="calculatePotentialManual();">
                                <span class="input-group-text">%</span>
                            </div>
                            <div class="input-group mb-2 automatic-field" style="display: none;">
                                <span class="input-group-text">Accuracy</span>
                                <input type="number" class="form-control highlight-green" id="otherAggregatesAccuracy" value="0.5" oninput="calculatePotentialAutomatic();">
                                <span class="input-group-text">+/- %</span>
                            </div>
                            <div class="input-group">
                                <span class="input-group-text">Potential Maximum Unknown Moisture</span>
                                <input type="text" class="form-control" id="otherAggregatesPotential" readonly>
                                <span class="input-group-text">%</span>
                            </div>
                        </div>
                    </div>
