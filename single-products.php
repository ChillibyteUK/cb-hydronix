            ...
            <div class="row">
                <div class="col-lg-7 d-flex justify-content-center align-items-center px-5">
                    ...
                    if (get_the_post_thumbnail_url(get_the_ID(),'full')) {
                        ?>
                    <img src="<?=get_the_post_thumbnail_url(get_the_ID(),'full')?>" class="phero__image">
                        <?php
                    }
                    ?>
                </div>
...
<!--section class="sub_page_title py-1 mb-4">
    ...
    ?>
    <section class="details py-5" style="background-image:url(<?=$img?>)">
        <div class="container responsive-tabs">
            <ul id="tabs" class="nav nav-tabs" role="tablist">
                <li class="nav-item">
                    <a id="overview" href="#pane-Overview" class="nav-link active" data-bs-toggle="tab" role="tab"><?=__('Overview','cb-hydronix')?></a>
                </li>
                <?php
                if (get_field('installation_points')) {
                    ?>
                <li class="nav-item">
                    <a id="installation" href="#pane-Installation" class="nav-link" data-bs-toggle="tab" role="tab"><?=__('Installation','cb-hydronix')?></a>
                </li>
                    <?php
                }
                if (get_field('installation_by_connectivity')) {
                    ?>
                <li class="nav-item">
                    <a id="installationConn" href="#pane-InstallationConn" class="nav-link" data-bs-toggle="tab" role="tab"><?=__('Installation by Connectivity','cb-hydronix')?></a>
                </li>
                    <?php
                }
                if (get_field('accessories')) {
                    ?>
                <li class="nav-item">
                    <a id="accessories" href="#pane-Accessories" class="nav-link" data-bs-toggle="tab" role="tab"><?=__('Accessories','cb-hydronix')?></a>
                </li>
                    <?php
                }
                ...
                if (get_field('interfaces')) {
                    ?>
                <li class="nav-item">
                    <a id="connectivity" href="#pane-Connectivity" class="nav-link" data-bs-toggle="tab" role="tab"><?=__('Connectivity','cb-hydronix')?></a>
                </li>
                    <?php
                }
                if (get_field('products')) {
                    ?>
                <li class="nav-item">
                    <a id="products" href="#pane-Products" class="nav-link" data-bs-toggle="tab" role="tab"><?=__('Associated Products','cb-hydronix')?></a>
                </li>
                    <?php
                }
                ?>
            ...
            <div id="content" class="tab-content" role="tablist">
                <div id="pane-Overview" class="card tab-pane fade show active" role="tabpanel" aria-labelledby="overview">
                    <div class="card-header" role="tab" id="heading-Overview">
                        <div class="h5 mb-0">
                            <a data-bs-toggle="collapse" href="#collapse-Overview" aria-expanded="true" aria-controls="collaspe-Overview">
                                <?=__('Overview','cb-hydronix')?>
                            </a>
                        </div>
                    </div>
                    <div id="collapse-Overview" class="collapse show" data-bs-parent="#content" role="tabpanel" aria-labelledby="heading-Overview">
                            ...
                            <div class="row">
                                <div class="col-lg-8 order-2 order-lg-1 cols-lg-2">
                                    ...
                                    if (get_field('overview')) {
                                        ?>
                                    <h3 class="fs-5 mb-3"><?=__('Measurement','cb-hydronix')?>:</h3>
                                    <ul>
                                    ...
                                    if (get_field('typical_materials')) {
                                        ?>
                                    <h3 class="fs-5 mb-3"><?=__('Typical Materials','cb-hydronix')?>:</h3>
                                    <ul>
                                    ...
                                    if (get_field('installation')) {
                                        ?>
                                    <h3 class="fs-5 mb-3"><?=__('Installation Points','cb-hydronix')?>:</h3>
                                    <ul>
                                    ...
                                    if (get_field('key_features')) {
                                        ?>
                                    <h3 class="fs-5 mb-3"><?=__('Unique Key Features','cb-hydronix')?>:</h3>
                                    <ul>
                                ...
                                <div class="col-lg-4 order-1 order-lg-3">
                                    ...
                                    <?php
                                        ...
                                        if (get_field('video_id')) {
                                            ...
                                            ?>
                                            <li data-thumb="<?=$thumb?>">
                                                <a href="https://player.vimeo.com/video/<?=get_field('video_id')?>?byline=0&portrait=0" data-fancybox="gallery">
                                                    <img src="<?=get_stylesheet_directory_uri()?>/img/missing-video.png">
                                        ...
                                        add_action('wp_footer',function(){
                                            ?>
<script src="<?=get_stylesheet_directory_uri()?>/js/lightslider.min.js"></script>
...
*/
                        ...
                        <div class="container p-0">
                            <div class="process-steps">
                                <h2 class="fs-4 mb-2"><?=__('Processes','cb-hydronix')?></h2>
                                ...
                                foreach ($psteps as $p) {
                                    ...
                                    <div class="process-steps__step">
                                        <a href="<?=__('/processes/','cb-hydronix')?><?=$p->slug?>/">
                                            <img src="<?=get_stylesheet_directory_uri()?><?=$f?>" class="mb-2" alt="<?=$p->slug?>">
                                            <div class="process-steps__name"><?=$p->name?></div>
                                        </a>
                                    </div>
                                    <?php
                                }
                ...
                <div id="pane-Installation" class="card tab-pane fade" role="tabpanel" aria-labelledby="installation">
                    <div class="card-header" role="tab" id="heading-Installation">
                        <div class="h5 mb-0">
                            <a class="collapsed" data-bs-toggle="collapse" href="#collapse-Installation" aria-expanded="true" aria-controls="collapse-Installation">
                                <?=__('Installation','cb-hydronix')?>
                            </a>
                        </div>
                    </div>
                    <div id="collapse-Installation" class="collapse" data-bs-parent="#content" role="tabpanel" aria-labelledby="heading-Installation">
                        <div class="card-body py-5">
                            ...
                            foreach(get_field('installation_points') as $p) {
                                ...
                                <div class="col-lg-6 col-xl-4">
                                    <div class="install__card">
                                        <h3 class="fs-5 mb-3"><?=$p->name?></h3>
                                        <div class="row g-2">
                                            <div class="col-md-6 order-1 order-md-2 text-center">
                                                <a href="<?=wp_get_attachment_image_url(get_field('image',$p), 'large' )?>" data-fancybox="gallery">
                                                    <img src="<?=wp_get_attachment_image_url(get_field('image',$p), 'medium' )?>">
                                                </a>
                ...
                <div id="pane-InstallationConn" class="card tab-pane fade" role="tabpanel" aria-labelledby="installationConn">
                    <div class="card-header" role="tab" id="heading-InstallationConn">
                        <div class="h5 mb-0">
                            <a class="collapsed" data-bs-toggle="collapse" href="#collapse-InstallationConn" aria-expanded="true" aria-controls="collapse-Installation">
                                <?=__('Installation by Connectivity','cb-hydronix')?>
                            </a>
                        </div>
                    </div>
                    <div id="collapse-InstallationConn" class="collapse" data-bs-parent="#content" role="tabpanel" aria-labelledby="heading-InstallationConn">
                        <div class="card-body py-5">
                ...
                <div id="pane-Accessories" class="card tab-pane fade" role="tabpanel" aria-labelledby="accessories">
                    <div class="card-header" role="tab" id="heading-Accessories">
                        <div class="h5 mb-0">
                            <a class="collapsed" data-bs-toggle="collapse" href="#collapse-Accessories" aria-expanded="true" aria-controls="collapse-Accessories">
                                <?=__('Accessories','cb-hydronix')?>
                            </a>
                        </div>
                    </div>
                    <div id="collapse-Accessories" class="collapse" data-bs-parent="#content" role="tabpanel" aria-labelledby="heading-Accessories">
                        <div class="card-body py-5">
                ...
                add_action('wp_footer', function() {
                    ?>
<link rel="stylesheet" href="<?=get_stylesheet_directory_uri()?>/css/lightbox.min.css">
<script src="<?=get_stylesheet_directory_uri()?>/js/lightbox.min.js"></script>
                    <?php                    
                });
                ...
                <div id="pane-Features" class="card tab-pane fade" role="tabpanel" aria-labelledby="features">
                    <div class="card-header" role="tab" id="heading-Features">
                        <div class="h5 mb-0">
                            <a class="collapsed" data-bs-toggle="collapse" href="#collapse-Features" aria-expanded="true" aria-controls="collapse-Features">
                                <?=__('Features','cb-hydronix')?>
                            </a>
                        </div>
                    </div>
                    <div id="collapse-Features" class="collapse" data-bs-parent="#content" role="tabpanel" aria-labelledby="heading-Features">
                ...
                <div id="pane-Connectivity" class="card tab-pane fade" role="tabpanel" aria-labelledby="connectivity">
                    <div class="card-header" role="tab" id="heading-Connectivity">
                        <div class="h5 mb-0">
                            <a class="collapsed" data-bs-toggle="collapse" href="#collapse-Connectivity" aria-expanded="true" aria-controls="collapse-Connectivity">
                                <?=__('Sensor Connectivity','cb-hydronix')?>
                            </a>
                        </div>
                    </div>
                    <div id="collapse-Connectivity" class="collapse" data-bs-parent="#content" role="tabpanel" aria-labelledby="heading-Connectivity">
                        <div class="card-body pt-5">
                            <div class="row g-4">
                                ...
                                <div class="col-xl-6">
                                    ...
                                    <div class="py-4">
                                        ...
                                        <ul>
                                            <li><?=__('Six pairs twisted (12 cores total) screened (shielded) cable with 22 AWG, 0.35mm2 conductors','cb-hydronix')?></li>
                                            <li><?=__('Screen (shield): Braid with 65% minimum coverage plus aluminium/polyester foil','cb-hydronix')?></li>
                                            <li><?=__('Recommended cable types: Belden 8306, Alpha 6373','cb-hydronix')?></li>
                                            <li><?=__('Maximum cable run: 100m, separate to any heavy equipment power cables','cb-hydronix')?></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            ...
                            foreach (get_field('interfaces') as $i) {
                                ...
                                <div class="col-sm-6 col-lg-3">
                                    <div class="product__card" href="<?=get_the_permalink($i)?>">
                                        <img src="<?=get_the_post_thumbnail_url($i,'medium')?>">
                                    ...
                                    ?>
                                <div class="col-sm-6 col-lg-3">
                                    <a class="product__card" href="<?=get_the_permalink($i)?>">
                                        <img src="<?=get_the_post_thumbnail_url($i,'medium')?>">
                                        <div><?=get_the_title($i)?></div>            
                                    </a>
                                </div>
    ...
    <section id="form" class="py-5">
        <div class="container col-lg-8 offset-lg-2">
            <h2 class="h2 text--blue mb-4"><?=__('Enquire about','cb-hydronix')?> <?=get_the_title()?></h2>
            <!--[if lte IE 8]>
