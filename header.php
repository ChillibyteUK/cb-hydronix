...
<div class="site" id="page">
	<div id="wrapper-navbar" class="fixed-top">
		...
		<a class="skip-link sr-only sr-only-focusable" href="#content"><?php esc_html_e( 'Skip to content', 'cb-hydronix' ); ?></a>
		...
		<nav id="nav" class="navbar navbar-expand-lg navbar-light d-block p-0" aria-labelledby="nav-label">
			<div id="top-nav">
                <div class="container-xl d-flex align-items-center justify-content-between">
                            ...
                            <div class="mb-2 text-center text-lg-end">
                                <div id="searchBox" class="d-none">
                                    <form id="search" class="d-flex w-100 justify-content-center" action="/" method="get" accept-charset="utf-8">
                                        <input type="text" name="s" id="search-s" value="" class="align-self-center search-input form-control" autofocus />
                                        <input type="hidden" name="post_type" value="products, events" />
                                    </form>
                                </div>
                                <div id="searchTrigger" class="d-block d-lg-inline me-4"><i class="fa fa-search"></i></div>
                                ...
                                ?></div>
                                <div class="d-block d-lg-inline me-4"><a href="/about-hydronix/contact-us/">Contact</a></div>
                                <div class="d-block d-lg-inline me-4"><a href="/resources/downloads/">Downloads</a></div>
                                <?php
                                /*
                    ...
                    <div class="d-inline d-lg-none me-2 align-self-end mb-3"><?php
                        wp_nav_menu(array(
                            'theme_location'  => 'lang_nav',
                            'container_class' => 'd-inline-block',
                            'menu_class' => 'navbar-nav',
                    ...
                    <div class="d-lg-none align-self-end mb-3 ml-auto">
                        ...
                        <button class="navbar-toggler collapsed align-self-end ml-auto input-button me-2" id="navToggle" data-bs-toggle="collapse" data-bs-target="#primaryNav" type="button" style="border-color: rgba(0,0,0,.5);">
